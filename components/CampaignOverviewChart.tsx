...
export const CampaignOverviewChart: React.FC<CampaignOverviewChartProps> = ({ data }) => {
  return (
    <div className="bg-slate-900/70 border border-slate-800 rounded-xl p-5 backdrop-blur-sm shadow-lg h-96">
      <h3 className="text-lg font-bold text-white mb-4">Campaign Reach & Engagement</h3>
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 5, right: 20, left: -10, bottom: 40 }}>
          ...
          <XAxis dataKey="date" tick={{ fill: '#9ca3af', fontSize: 12 }} tickLine={{ stroke: '#4b5563' }} />
          <YAxis tick={{ fill: '#9ca3af', fontSize: 12 }} tickLine={{ stroke: '#4b5563' }} />
